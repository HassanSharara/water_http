...
use water_http::{WaterController, DataHolderInitializer, RunServer, get_route_by_name, MiddlewareBuilder, WaterServerConfigurations};
...
#[tokio::main]
async fn main() {
    let config = WaterServerConfigurations::bind("localhost",8084);
    RunServer!(
        config,
